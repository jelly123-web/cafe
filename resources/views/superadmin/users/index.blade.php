    ...
    @push('head')
        ...
        <style>
            ...
            .drawer-head h3 { margin: 0; font-family: var(--font); font-weight: 800; color: var(--fg); font-size: 1.35rem; }
            .drawer-close {
            ...
            .drawer-close:hover { background: var(--red-light); border-color: var(--red); color: var(--red); }
            ...
            .cropper-box img:hover { border-color: var(--accent); }
            .photo-clear {
                position: absolute;
                top: -8px;
                right: -8px;
            ...
            .cropper-foot { border-bottom: 0; border-top: 1px solid var(--border); justify-content: flex-end; }
            .cropper-head strong { color: var(--fg); font-weight: 800; font-size: 1.2rem; }
            .cropper-body {
                display: grid;
                place-items: center;
                gap: 0.85rem;
            ...
            .cropper-control input { accent-color: var(--accent); }
            ...
            .cropper-done { background: var(--accent); color: #fff; border-color: var(--accent); }
            ...
            .btn-drawer-cancel:hover { background: var(--red-light); border-color: var(--red); color: var(--red); }
            
            .user-drawer .drawer-head { padding: 1.25rem 1.4rem; }
            .user-drawer .drawer-body { padding: 1.5rem 1.4rem; }
            .user-drawer .user-form { gap: 1.25rem; }
            .user-drawer .form-grid { gap: 1.4rem 1.2rem; }
            .user-drawer .drawer-field { gap: 0.55rem; }
            .user-drawer .drawer-field input[type="text"],
            .user-drawer .drawer-field input[type="password"],
            .user-drawer .drawer-field select { min-height: 48px; }
            .user-drawer .drawer-foot { padding: 1.15rem 1.4rem; gap: 0.9rem; }
            .user-drawer .btn-drawer-cancel,
            .user-drawer .primary-link { min-height: 46px; padding-left: 1.5rem; padding-right: 1.5rem; }
            .user-drawer .drawer-close { min-height: 40px; padding: 0.5rem 0.95rem; }
            .user-drawer .photo-picker-btn { min-height: 46px; }
            .user-drawer .drawer-field input[type="file"] { min-height: 48px; }
            ...
            (function () {
                ...
                form.addEventListener('submit', async function (e) {
                    ...
                    try {
                        ...
                        let res = await submitRequest(csrfToken);
                        if (res.status === 419) {
                            csrfToken = await refreshCsrfToken();
                            res = await submitRequest(csrfToken);
                        }
