...
@section('content')
    <div class="panel">
        <form method="POST" action="{{ route('superadmin.menus.store') }}" class="menu-form" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-grid">
                ...
                <div class="field">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Cth: Caramel Macchiato" required>
                    @error('name')<small class="form-error">{{ $message }}</small>@enderror
                </div>

                <div class="field">
                    <label for="selling_price">Harga Jual</label>
                    <input id="selling_price" type="number" step="0.01" name="selling_price" value="{{ old('selling_price') }}" placeholder="35000" required>
                    @error('selling_price')<small class="form-error">{{ $message }}</small>@enderror
                </div>

                <div class="field">
                    <label for="cost_price">Harga Modal</label>
                    <input id="cost_price" type="number" step="0.01" name="cost_price" value="{{ old('cost_price') }}" placeholder="12000" required>
                ...
                <div class="field image-box">
                    ...
                    <img
                        ...
                        src="{{ asset('images/menu-placeholder.svg') }}"
                        alt="Preview menu"
                    >
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="primary-link">Buat Menu</button>
            </div>
        </form>
    </div>
