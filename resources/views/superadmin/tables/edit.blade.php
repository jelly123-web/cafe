...
@section('page_description', 'Ubah nama dan nomor meja yang dipakai untuk QR pelanggan.')
...
@section('content')
    <div class="form-card">
        <form method="POST" action="{{ route('superadmin.tables.update', $table) }}" class="form-grid">
            @csrf
            @method('PUT')

            <div class="field">
                <label for="number">Nomor Meja</label>
                <input id="number" type="text" name="number" value="{{ old('number', $table->number) }}" required>
                @error('number')<small class="form-error">{{ $message }}</small>@enderror
            </div>

            <div class="field">
                <label for="name">Nama Meja</label>
                <input id="name" type="text" name="name" value="{{ old('name', $table->name) }}" required>
            ...
            <div class="actions">
                <button class="primary-link" type="submit">Simpan Perubahan</button>
